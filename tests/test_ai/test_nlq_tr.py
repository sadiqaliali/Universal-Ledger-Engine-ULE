"""Tests for Natural Language Query - Turkish."""

import pytest
from ule.ai.nlq import NaturalLanguageQuery


class TestNLQTurkish:
    """Test Turkish NLQ patterns."""
    ...
    def test_show_all(self, temp_db):
        ...
        results = nlq.ask("tüm kullanıcıları göster", language="tr")
    ...
    def test_show_with_age_condition(self, temp_db):
        ...
        nlq = NaturalLanguageQuery(temp_db._conn)
        results = nlq.ask("yaşı 26 dan büyük kullanıcıları göster", language="tr")
    ...
    def test_count(self, temp_db):
        ...
        nlq = NaturalLanguageQuery(temp_db._conn)
        results = nlq.ask("toplam users sayısını göster", language="tr")
    ...
    def test_translate(self, temp_db):
        ...
        sql = nlq.translate("tüm users göster", language="tr")
